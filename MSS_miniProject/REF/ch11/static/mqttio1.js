...
const CLIENT_ID = "client-" +
  Math.floor((1 + Math.random()) * 0x10000000000).toString(16); // 사용자 ID 랜덤 생성
...
function startConnect() { // 브로커에 접속하는 함수
  ...
  document.getElementById("messages").innerHTML += "<span>접속 : " + broker +
    " 포트 " + port + "</span><br/>";
...
function onMessageArrived(msg) { // 매개변수 msg는 도착한 MQTT 메시지를 담고 있는 객체
  ...
  // 도착한 메시지 출력
  document.getElementById("messages").innerHTML += "<span>토픽 : " +
